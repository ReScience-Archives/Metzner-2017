...
\fancyfoot[R]{\sffamily Apr 2017 $\vert$
                        Volume \textbf{3} $\vert$
                        Issue \textbf{1}}
\pagestyle{fancy}
\makeatletter
...
\marginpar{
  ...
  {\bfseries Received}  Apr, 19, 2017\\
  {\bfseries Accepted}  Aug, 30, 2017\\
  {\bfseries Published} Aug, 30, 2017\\
  ...
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Metzner-2017/tree/master/article}{\faGithubAlt~Article repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Metzner-2017/tree/master/code}{\faGithubAlt~Code repository}
  \end{repobox}
        \hypersetup{urlcolor=blue}
}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{Replication-Figure6.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{Replication-Figure7.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{Replication-Figure10.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{Replication-Figure11.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.65\textwidth]{Noise-Exploration-MEG.eps}
\caption{Raw simulated MEG signals (averaged
over 20 trials) for the control and the schizophrenic network at 20 and 40 Hz driving frequencies 
for three different levels of noise strength (0, 50 and 75 \% of the strength in the standard model).}\label{fig:NoiseExplorationMEG}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{Noise-Exploration-PSD.eps}
\caption{Power spectra of the raw MEG signals from \ref{fig:NoiseExplorationMEG}}\label{fig:NoiseExplorationPSD}
\end{figure}
...
overall features are a little bit less pronounced in our
